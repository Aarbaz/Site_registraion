...
class SiteController extends Controller
{
    ...
    $req->validate([
                ...
                'e_pin' => 'required_if:yesno,yes',
                'qstn' => 'required_if:yesno,yes'
                ...
                'email.required' => 'Office Email is required',
                'state.required' => 'State Name is required',
                'pin.required' => 'Pin is required',
                'yesno.required' => 'Ethic commettee answer is required',		
                ...
                'qstn.required' => 'Ethics Committee register?'
